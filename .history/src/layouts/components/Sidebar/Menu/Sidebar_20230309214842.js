            ...
            <footer>
                <div className={cx('row')}>
                    ...
                    <div className={cx('col')}>
                        ...
                        Thay đổi thuộc tính to trong các MenuItem của Menu để trỏ tới các đường dẫn tương ứng: jsx Copy
                        code
                        <Menu>
                        ...
                        Sau khi sửa lại code như trên, khi nhấn vào các menu item, trang sẽ chuyển sang địa chỉ tương
                        ứng với href của a trong phần Links của footer.
                    </div>
                    <div className={cx('col')}>
                        <h3>
                            Newsletter{' '}
